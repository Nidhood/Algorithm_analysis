...
def generate_sequence(n, seed=None):
    """Genera una secuencia de precios aleatorios de longitud n."""
    if seed is not None:
        random.seed(seed)
    return [random.randint(1, 100) for _ in range(n)]

def measure_time(seq, func):
    """Mide el tiempo de ejecución de func(seq) en nanosegundos."""
...
def run_experiments(min_n, max_n, step_n, output_file):
    """Ejecuta experimentos variando n y guarda resultados en un CSV."""
